    ...
    function routesConfig($stateProvider, $locationProvider, $urlRouterProvider, helper){
        ...
        $stateProvider
          ...
          .state('app.collect', {
              url: '/collect',
              title: 'Collect Fees',
              templateUrl: helper.basepath('collect.html'),
              resolve: helper.resolveFor('loadGoogleMapsJS', function() { return loadGoogleMaps(); }, 'ui.map')
          })
          .state('app.royalty', {
              url: '/royalty',
              title: 'Royalty',
              templateUrl: helper.basepath('royalty.html'),
              resolve: helper.resolveFor('loadGoogleMapsJS', function() { return loadGoogleMaps(); }, 'ui.map')
          })
          .state('app.leaderboard', {
              url: '/leaderboard',
              title: 'Leaderboard',
              templateUrl: helper.basepath('leaderboard.html'),
              resolve: helper.resolveFor('loadGoogleMapsJS', function() { return loadGoogleMaps(); }, 'ui.map')
          })
          ...
          .state('app.affiliate', {
              url: '/affiliate',
              title: 'Affiliate',
              templateUrl: helper.basepath('affiliate.html'),
              resolve: helper.resolveFor('loadGoogleMapsJS', function() { return loadGoogleMaps(); }, 'ui.map')
          })
          .state('app.promotion', {
              url: '/promotion',
              title: 'Promotion',
              templateUrl: helper.basepath('promotion.html'),
              resolve: helper.resolveFor('loadGoogleMapsJS', function() { return loadGoogleMaps(); }, 'ui.map')
          })
          ...
          .state('app.content', {
              url: '/content',
              title: 'Content',
              templateUrl: helper.basepath('content.html'),
              resolve: helper.resolveFor('loadGoogleMapsJS', function() { return loadGoogleMaps(); }, 'ui.map')
          })
          .state('app.technical', {
              url: '/technical',
              title: 'Technical',
              templateUrl: helper.basepath('technical.html'),
              resolve: helper.resolveFor('loadGoogleMapsJS', function() { return loadGoogleMaps(); }, 'ui.map')
          })
          .state('app.buttons', {
              url: '/buttons',
